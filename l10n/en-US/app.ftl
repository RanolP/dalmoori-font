...
landing-section-download-stable-channel-title = Stable Channel
landing-section-download-unstable-channel-title = Unstable Channel (Requires GitHub Login)
landing-section-download-unstable-channel-description =
    Unstable Channel provides a file generated by the commits from main branch of GitHub repository.
    This files can be malfunction, and anytime not be able to download.
    Thus, you should be careful when you're using a file from Unstable Channel.